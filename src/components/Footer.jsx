...
const Footer = () => {
  return (
    <div className="w-full mt-24 bg-slate-900 text-gray-300 py-y px-2">
        ...
        <p className='py-4'>2022 Guru Dev Group, LLC. All Rights Reserved</p>
        <p className='py-4'>
            Designed and developed by Raedal Tech Solutions
            {/* <img src={Logo} alt='www.raedaltech.com' sizes='10px'/> */}
        </p>
